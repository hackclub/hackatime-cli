...
func NewClient(ctx context.Context, params params.API) (*api.Client, error) {
...
func NewClientWithoutAuth(ctx context.Context, params params.API) (*api.Client, error) {
	return newClient(ctx, params)
}

// newClient contains the logic of client initialization, except auth initialization.
func newClient(ctx context.Context, params params.API, opts ...api.Option) (*api.Client, error) {
